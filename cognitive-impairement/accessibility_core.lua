...
-- mGBA's Lua (5.4) has native bitwise operators but no `bit` library, which
-- some environments provide. define a small bit table from the native operators
-- so the rest of the engine can use bit.band / bit.bor / bit.bnot unchanged.
if not bit then
    bit = {
